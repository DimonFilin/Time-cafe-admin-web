...
import { AVAILABLE_PERMISSIONS, type ApiKey } from '../api/api-keys';
...
export function EditApiKeyModal({
  ...
  const [form, setForm] = useState<EditApiKeyFormData>(initialForm);
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-2">Permissions (Optional to update)</label>
